        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 py-4 bg-card rounded-lg shadow-lg">
            <nav className="flex flex-col space-y-4 px-6">
              ...
              <a href="#how-it-works" className="text-white/80 hover:text-white py-2 transition-colors">How It Works</a>
              <a href="#pricing" className="text-white/80 hover:text-white py-2 transition-colors">Pricing</a>
              <a href="#faq" className="text-white/80 hover:text-white py-2 transition-colors">FAQ</a>
